...
const Home: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Jessy's Hacker House | BuidlGuidl Grants (autonomous worlds cohort)</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:title" content="Jessy's Hacker House | BuidlGuidl Grants (autonomous worlds cohort)" />
        <meta
          ...
          {isLoadingBuilderData || isLoadingBuilderEvents ? (
            ...
            <>
              {allBuildersData?.map(builderData => {
                if (builderData?.cap?.eq(ethers.utils.parseEther("0"))) return;
