...
const Home: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Jessy's Hacker House | BuidlGuidl Grants (Infrastructure Cohort)</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:title" content="Jessy's Hacker House | BuidlGuidl Grants (Infrastructure Cohort)" />
        <meta
