  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="We're running an experiment to retroactively fund open-source work by providing a monthly UBI to open-source developers, handpicked by the Hacker House Leader, and rewarding them for their ongoing contributions to the ecosystem."
        />
